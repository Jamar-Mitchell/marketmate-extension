...
function createOverlayContainer(inputElement: Element): HTMLElement {
  ...
  if (!container) {
    ...
    const inputContainer = inputElement.closest('[role="main"]') || inputElement.parentElement;
    if (inputContainer) {
      inputContainer.insertBefore(container, inputElement.closest('form') || inputElement);
    } else {
