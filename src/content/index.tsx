...
import { extractListingData, getMockListingData, observeListingChanges } from './domExtractor';
...
const MarketMateApp: React.FC = () => {
  ...
  React.useEffect(() => {
    const initialize = () => {
      const data = preferences.mockMode ? getMockListingData() : extractListingData();
      setListing(data);
